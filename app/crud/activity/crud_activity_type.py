...
from app.schemas.activity.activity_type_create import ActivityTypeCreate
from app.schemas.activity.activity_type_update import ActivityTypeUpdate


class CRUDActivityType(CRUDBase[ActivityType]):

    def create(self, db: Session, data: ActivityTypeCreate) -> ActivityType:
